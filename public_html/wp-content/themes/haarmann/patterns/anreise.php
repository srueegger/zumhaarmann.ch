...
<section class="wp-block-group alignfull section-anreise has-cream-color has-dark-soft-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--30)">
	<!-- wp:heading {"textAlign":"center","level":2,"textColor":"gold","fontSize":"xx-large","style":{"typography":{"textTransform":"uppercase","letterSpacing":"0.06em"},"spacing":{"margin":{"bottom":"var:preset|spacing|40"}}},"anchor":"anreise"} -->
	<h2 id="anreise" class="wp-block-heading has-text-align-center has-gold-color has-text-color has-xx-large-font-size" style="margin-bottom:var(--wp--preset--spacing--40);letter-spacing:0.06em;text-transform:uppercase"><?php esc_html_e( 'Anreise', 'haarmann' ); ?></h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			<!-- wp:heading {"level":3,"fontSize":"medium","style":{"typography":{"textTransform":"uppercase","letterSpacing":"0.06em","fontWeight":"500"}}} -->
			<h3 class="wp-block-heading has-medium-font-size" style="font-weight:500;letter-spacing:0.06em;text-transform:uppercase"><?php esc_html_e( 'Mit dem ÖV', 'haarmann' ); ?></h3>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			<!-- wp:heading {"level":3,"fontSize":"medium","style":{"typography":{"textTransform":"uppercase","letterSpacing":"0.06em","fontWeight":"500"}}} -->
			<h3 class="wp-block-heading has-medium-font-size" style="font-weight:500;letter-spacing:0.06em;text-transform:uppercase"><?php esc_html_e( 'Mit dem Auto', 'haarmann' ); ?></h3>
			<!-- /wp:heading -->
