...
<div class="wp-block-cover alignfull is-light" style="aspect-ratio:16/9">
	...
	<img class="wp-block-cover__image-background" alt="<?php esc_attr_e( 'Barbershop-Atmosphäre', 'haarmann' ); ?>" src="<?php echo esc_url( get_theme_file_uri( 'assets/images/hero.jpg' ) ); ?>" data-object-fit="contain"/>
