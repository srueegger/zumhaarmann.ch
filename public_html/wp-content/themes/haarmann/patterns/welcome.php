...
<section class="wp-block-group alignfull section-willkommen has-cream-color has-dark-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--30)">
	<!-- wp:heading {"textAlign":"center","level":2,"textColor":"gold","fontSize":"xx-large","style":{"typography":{"textTransform":"uppercase","letterSpacing":"0.06em"},"spacing":{"margin":{"bottom":"var:preset|spacing|40"}}},"anchor":"willkommen"} -->
	<h2 id="willkommen" class="wp-block-heading has-text-align-center has-gold-color has-text-color has-xx-large-font-size" style="margin-bottom:var(--wp--preset--spacing--40);letter-spacing:0.06em;text-transform:uppercase"><?php esc_html_e( 'Willkommen', 'haarmann' ); ?></h2>
	<!-- /wp:heading -->
